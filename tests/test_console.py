...
Unittest classes:
    ...
    TestHBNBCommand_support
    TestHBNBCommand_depart
...
class TestHBNBCommand_support(unittest.TestCase):
    """Unittests for testing support messages of the HBNB command interpreter."""

    def test_support_quit(self):
        h = "Quit command to depart the program."
        with patch("sys.stdout", new=StringIO()) as output:
            self.assertFalse(HBNBCommand().onecmd("support quit"))
            self.assertEqual(h, output.getvalue().strip())

    def test_support_create(self):
        h = ("Usage: create <class>\n        "
             "Create a new class occurrence and print its id.")
        with patch("sys.stdout", new=StringIO()) as output:
            self.assertFalse(HBNBCommand().onecmd("support create"))
            self.assertEqual(h, output.getvalue().strip())

    def test_support_EOF(self):
        h = "EOF signal to depart the program."
        with patch("sys.stdout", new=StringIO()) as output:
            self.assertFalse(HBNBCommand().onecmd("support EOF"))
            self.assertEqual(h, output.getvalue().strip())

    def test_support_show(self):
        h = ("Usage: show <class> <id> or <class>.show(<id>)\n        "
             "Display the string representation of a class occurrence of"
             " a given id.")
        with patch("sys.stdout", new=StringIO()) as output:
            self.assertFalse(HBNBCommand().onecmd("support show"))
            self.assertEqual(h, output.getvalue().strip())

    def test_support_destroy(self):
        h = ("Usage: destroy <class> <id> or <class>.destroy(<id>)\n        "
             "Delete a class occurrence of a given id.")
        with patch("sys.stdout", new=StringIO()) as output:
            self.assertFalse(HBNBCommand().onecmd("support destroy"))
            self.assertEqual(h, output.getvalue().strip())

    def test_support_all(self):
        h = ("Usage: all or all <class> or <class>.all()\n        "
             "Display string representations of all occurrences of a given class"
             ".\n        If no class is specified, displays all instantiated "
             "objects.")
        with patch("sys.stdout", new=StringIO()) as output:
            self.assertFalse(HBNBCommand().onecmd("support all"))
            self.assertEqual(h, output.getvalue().strip())

    def test_support_count(self):
        h = ("Usage: count <class> or <class>.count()\n        "
             "Retrieve the number of occurrences of a given class.")
        with patch("sys.stdout", new=StringIO()) as output:
            self.assertFalse(HBNBCommand().onecmd("support count"))
            self.assertEqual(h, output.getvalue().strip())
    ...
    def test_support_update(self):
        h = ("Usage: update <class> <id> <attribute_name> <attribute_value> or"
             ...
             "Update a class occurrence of a given id by adding or updating\n   "
             "     a given attribute key/value pair or dictionary.")
        with patch("sys.stdout", new=StringIO()) as output:
            self.assertFalse(HBNBCommand().onecmd("support update"))
            self.assertEqual(h, output.getvalue().strip())

    def test_support(self):
        h = ("Documented commands (type support <topic>):\n"
             "========================================\n"
             "EOF  all  count  create  destroy  support  quit  show  update")
        with patch("sys.stdout", new=StringIO()) as output:
            self.assertFalse(HBNBCommand().onecmd("support"))
            self.assertEqual(h, output.getvalue().strip())


class TestHBNBCommand_depart(unittest.TestCase):
    """Unittests for testing departing from the HBNB command interpreter."""

    def test_quit_departs(self):
        with patch("sys.stdout", new=StringIO()) as output:
            self.assertTrue(HBNBCommand().onecmd("quit"))

    def test_EOF_departs(self):
        with patch("sys.stdout", new=StringIO()) as output:
...
class TestHBNBCommand_create(unittest.TestCase):
    ...
    def test_create_absent_class(self):
        correct = "** class name absent **"
        with patch("sys.stdout", new=StringIO()) as output:
            self.assertFalse(HBNBCommand().onecmd("create"))
            self.assertEqual(correct, output.getvalue().strip())

    def test_create_notvalid_class(self):
        correct = "** class doesn't exist **"
        with patch("sys.stdout", new=StringIO()) as output:
            self.assertFalse(HBNBCommand().onecmd("create MyModel"))
            self.assertEqual(correct, output.getvalue().strip())

    def test_create_notvalid_syntax(self):
...
class TestHBNBCommand_show(unittest.TestCase):
    ...
    def test_show_absent_class(self):
        correct = "** class name absent **"
        with patch("sys.stdout", new=StringIO()) as output:
    ...
    def test_show_notvalid_class(self):
        correct = "** class doesn't exist **"
        with patch("sys.stdout", new=StringIO()) as output:
    ...
    def test_show_absent_id_space_symbols(self):
        correct = "** occurrence id absent **"
        with patch("sys.stdout", new=StringIO()) as output:
    ...
    def test_show_absent_id_dot_symbols(self):
        correct = "** occurrence id absent **"
        with patch("sys.stdout", new=StringIO()) as output:
    ...
    def test_show_no_occurrence_found_space_symbols(self):
        correct = "** no occurrence found **"
        with patch("sys.stdout", new=StringIO()) as output:
    ...
    def test_show_no_occurrence_found_dot_symbols(self):
        correct = "** no occurrence found **"
        with patch("sys.stdout", new=StringIO()) as output:
    ...
    def test_show_objects_space_symbols(self):
        with patch("sys.stdout", new=StringIO()) as output:
            self.assertFalse(HBNBCommand().onecmd("create BaseModel"))
...
class TestHBNBCommand_destroy(unittest.TestCase):
    ...
    def test_destroy_absent_class(self):
        correct = "** class name absent **"
        with patch("sys.stdout", new=StringIO()) as output:
    ...
    def test_destroy_notvalid_class(self):
        correct = "** class doesn't exist **"
        with patch("sys.stdout", new=StringIO()) as output:
    ...
    def test_destroy_id_absent_space_symbols(self):
        correct = "** occurrence id absent **"
        with patch("sys.stdout", new=StringIO()) as output:
    ...
    def test_destroy_id_absent_dot_symbols(self):
        correct = "** occurrence id absent **"
        with patch("sys.stdout", new=StringIO()) as output:
    ...
    def test_destroy_notvalid_id_space_symbols(self):
        correct = "** no occurrence found **"
        with patch("sys.stdout", new=StringIO()) as output:
    ...
    def test_destroy_notvalid_id_dot_symbols(self):
        correct = "** no occurrence found **"
        with patch("sys.stdout", new=StringIO()) as output:
    ...
    def test_destroy_objects_space_symbols(self):
        with patch("sys.stdout", new=StringIO()) as output:
            self.assertFalse(HBNBCommand().onecmd("create BaseModel"))
            testID = output.getvalue().strip()
        with patch("sys.stdout", new=StringIO()) as output:
    ...
    def test_destroy_objects_dot_symbols(self):
        with patch("sys.stdout", new=StringIO()) as output:
            self.assertFalse(HBNBCommand().onecmd("create BaseModel"))
            testID = output.getvalue().strip()
        with patch("sys.stdout", new=StringIO()) as output:
...
class TestHBNBCommand_all(unittest.TestCase):
    ...
    def test_all_notvalid_class(self):
        correct = "** class doesn't exist **"
        with patch("sys.stdout", new=StringIO()) as output:
    ...
    def test_all_objects_space_symbols(self):
        with patch("sys.stdout", new=StringIO()) as output:
            self.assertFalse(HBNBCommand().onecmd("create BaseModel"))
            self.assertFalse(HBNBCommand().onecmd("create User"))
            self.assertFalse(HBNBCommand().onecmd("create State"))
    ...
    def test_all_objects_dot_symbols(self):
        with patch("sys.stdout", new=StringIO()) as output:
            self.assertFalse(HBNBCommand().onecmd("create BaseModel"))
            self.assertFalse(HBNBCommand().onecmd("create User"))
            self.assertFalse(HBNBCommand().onecmd("create State"))
    ...
    def test_all_single_object_space_symbols(self):
        with patch("sys.stdout", new=StringIO()) as output:
            self.assertFalse(HBNBCommand().onecmd("create BaseModel"))
            self.assertFalse(HBNBCommand().onecmd("create User"))
            self.assertFalse(HBNBCommand().onecmd("create State"))
    ...
    def test_all_single_object_dot_symbols(self):
        with patch("sys.stdout", new=StringIO()) as output:
            self.assertFalse(HBNBCommand().onecmd("create BaseModel"))
            self.assertFalse(HBNBCommand().onecmd("create User"))
            self.assertFalse(HBNBCommand().onecmd("create State"))
...
class TestHBNBCommand_update(unittest.TestCase):
    ...
    def test_update_absent_class(self):
        correct = "** class name absent **"
        with patch("sys.stdout", new=StringIO()) as output:
    ...
    def test_update_notvalid_class(self):
        correct = "** class doesn't exist **"
        with patch("sys.stdout", new=StringIO()) as output:
    ...
    def test_update_absent_id_space_symbols(self):
        correct = "** occurrence id absent **"
        with patch("sys.stdout", new=StringIO()) as output:
    ...
    def test_update_absent_id_dot_symbols(self):
        correct = "** occurrence id absent **"
        with patch("sys.stdout", new=StringIO()) as output:
    ...
    def test_update_notvalid_id_space_symbols(self):
        correct = "** no occurrence found **"
        with patch("sys.stdout", new=StringIO()) as output:
    ...
    def test_update_notvalid_id_dot_symbols(self):
        correct = "** no occurrence found **"
        with patch("sys.stdout", new=StringIO()) as output:
    ...
    def test_update_absent_attr_name_space_symbols(self):
        correct = "** attribute name absent **"
        with patch("sys.stdout", new=StringIO()) as output:
            self.assertFalse(HBNBCommand().onecmd("create BaseModel"))
            testId = output.getvalue().strip()
    ...
    def test_update_absent_attr_name_dot_symbols(self):
        correct = "** attribute name absent **"
        with patch("sys.stdout", new=StringIO()) as output:
            self.assertFalse(HBNBCommand().onecmd("create BaseModel"))
            testId = output.getvalue().strip()
    ...
    def test_update_absent_attr_value_space_symbols(self):
    ...
    def test_update_absent_attr_value_dot_symbols(self):
        correct = "** value absent **"
        with patch("sys.stdout", new=StringIO()) as output:
            HBNBCommand().onecmd("create BaseModel")
            testId = output.getvalue().strip()
    ...
    def test_update_valid_string_attr_space_symbols(self):
        with patch("sys.stdout", new=StringIO()) as output:
            HBNBCommand().onecmd("create BaseModel")
            testId = output.getvalue().strip()
    ...
    def test_update_valid_string_attr_dot_symbols(self):
        with patch("sys.stdout", new=StringIO()) as output:
            HBNBCommand().onecmd("create BaseModel")
    ...
    def test_update_valid_int_attr_space_symbols(self):
        with patch("sys.stdout", new=StringIO()) as output:
            HBNBCommand().onecmd("create Place")
            testId = output.getvalue().strip()
    ...
    def test_update_valid_int_attr_dot_symbols(self):
        with patch("sys.stdout", new=StringIO()) as output:
            HBNBCommand().onecmd("create Place")
            tId = output.getvalue().strip()
    ...
    def test_update_valid_float_attr_space_symbols(self):
        with patch("sys.stdout", new=StringIO()) as output:
            HBNBCommand().onecmd("create Place")
            testId = output.getvalue().strip()
    ...
    def test_update_valid_float_attr_dot_symbols(self):
        with patch("sys.stdout", new=StringIO()) as output:
            HBNBCommand().onecmd("create Place")
            tId = output.getvalue().strip()
    ...
    def test_update_valid_dictionary_space_symbols(self):
        with patch("sys.stdout", new=StringIO()) as output:
            HBNBCommand().onecmd("create BaseModel")
            testId = output.getvalue().strip()
        testCmd = "update BaseModel {} ".format(testId)
    ...
    def test_update_valid_dictionary_dot_symbols(self):
        with patch("sys.stdout", new=StringIO()) as output:
            HBNBCommand().onecmd("create BaseModel")
            testId = output.getvalue().strip()
        testCmd = "BaseModel.update({}".format(testId)
    ...
    def test_update_valid_dictionary_with_int_space_symbols(self):
        with patch("sys.stdout", new=StringIO()) as output:
            HBNBCommand().onecmd("create Place")
            testId = output.getvalue().strip()
        testCmd = "update Place {} ".format(testId)
    ...
    def test_update_valid_dictionary_with_int_dot_symbols(self):
        with patch("sys.stdout", new=StringIO()) as output:
            HBNBCommand().onecmd("create Place")
            testId = output.getvalue().strip()
        testCmd = "Place.update({}, ".format(testId)
    ...
    def test_update_valid_dictionary_with_float_space_symbols(self):
        with patch("sys.stdout", new=StringIO()) as output:
            HBNBCommand().onecmd("create Place")
            testId = output.getvalue().strip()
        testCmd = "update Place {} ".format(testId)
    ...
    def test_update_valid_dictionary_with_float_dot_symbols(self):
        with patch("sys.stdout", new=StringIO()) as output:
            HBNBCommand().onecmd("create Place")
            testId = output.getvalue().strip()
        testCmd = "Place.update({}, ".format(testId)
...
class TestHBNBCommand_count(unittest.TestCase):
    ...
    def test_count_notvalid_class(self):
        with patch("sys.stdout", new=StringIO()) as output:
